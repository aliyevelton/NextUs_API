...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240807111053_Course entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseTagTag", b =>
                {
                    b.Property<int>("CoursesId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CourseTagTag");
                });

            modelBuilder.Entity("JobJobTag", b =>
                {
            ...
            modelBuilder.Entity("JobTagTag", b =>
                {
                    b.Property<int>("JobsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseCourseTag", b =>
                {
                    ...
                    b.HasOne("Core.Entities.CourseTag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("JobJobTag", b =>
                {
                    ...
                    b.HasOne("Core.Entities.JobTag", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
